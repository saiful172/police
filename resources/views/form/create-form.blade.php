  ...
  প্রার্থীর অফিস আইডি<span style="color: red; margin-left: 2px;">*</span>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <select name="is_freedom_fighter_related" id="is_freedom_fighter_related" onchange="toggleSection('is_freedom_fighter_related','freedom_fighter_doc_group')" required>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <select name="has_disability" id="has_disability" onchange="toggleSection('has_disability','disability_doc_group')" required>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <select name="has_police_case" id="has_police_case" onchange="toggleSection('has_police_case','police_case_details_group')" required>
                ...
                <div class="dynamic-row">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="নাম লিখুন" name="witnesses[0][name]" value="{{ old('witnesses.0.name') }}" required>
                        </div>
                        <div class="form-group">
                            <label>প্রথম ব্যক্তির ঠিকানা</label>
                            <input type="text" placeholder="ঠিকানা লিখুন" name="witnesses[0][address]" value="{{ old('witnesses.0.address') }}" required>
                        </div>
                    </div>
                </div>
                <div class="dynamic-row">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="নাম লিখুন" name="witnesses[1][name]" value="{{ old('witnesses.1.name') }}" required>
                        </div>
                        <div class="form-group">
                            <label>দ্বিতীয় ব্যক্তির ঠিকানা</label>
                            <input type="text" placeholder="ঠিকানা লিখুন" name="witnesses[1][address]" value="{{ old('witnesses.1.address') }}" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <select name="is_married" id="is_married" onchange="toggleSection('is_married','partner_nationality_group')" required>
